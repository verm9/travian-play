...
public class Entities {
    ...
    static {
        ...
        base = loadEntities("src/main/java/org/jsoup/nodes/entities-base.properties");  // most common / default
        baseByVal = toCharacterKey(base);
        full = loadEntities("src/main/java/org/jsoup/nodes/entities-full.properties"); // extended and overblown.
    ...
    private static Map<String, Character> loadEntities(String filename) {
        ...
        try {
            // The line below is modified. Replaced resource loading with getResourceAsStream, since the lib is used
            // unadvisory way (src copying). Also lines above in static initializer with path to .properties
            // are modified.
